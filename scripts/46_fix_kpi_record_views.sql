-- =============================================
-- Fix KPI Record Views
-- Created: 2026-02-08
-- Purpose: Create/recreate all views required for KPI Record pages
-- =============================================
...
WITH MilestoneDelivery AS (
    SELECT
        ...
        pm.due_date,
        pm.completed_date,
        -- Weight for Time to Delivery (using mdc_weight or default based on milestone name)
...
PRINT 'Created view: pms.vw_kpi_time_to_delivery';
GO
...
PRINT 'Created view: pms.vw_kpi_manday_control';
GO

-- 3. Defect Ratio View (already exists in 26_update_defect_ratio_view.sql, but include for completeness)
...
PRINT 'Created view: pms.vw_kpi_defect_ratio';
GO

PRINT 'All KPI Record views created successfully!';
GO
