-- =============================================
-- Script 64: Fix Manday Control View to use due_date for month
-- Description: Change month determination from ISNULL(completed_date, due_date)
--              to due_date only, matching the business rule that
--              milestone's month is based on its due date
-- =============================================
...
PRINT 'Updated view: pms.vw_kpi_manday_control (uses due_date for month, added HAVING)';
GO
