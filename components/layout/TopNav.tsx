                ...
                <Menu key={module.id} as="div" className="relative">
                  {({ open }) => (
                    <>
                      ...
                      >
                        <MenuItems className="absolute left-0 mt-2 w-72 origin-top-left bg-white rounded-xl shadow-2xl ring-1 ring-black/5 focus:outline-none z-50 overflow-y-auto max-h-[calc(100vh-100px)]">
