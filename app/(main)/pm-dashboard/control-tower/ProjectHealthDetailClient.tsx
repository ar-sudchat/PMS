...
export function ProjectHealthDetailClient({
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
            {/* Header */}
            <div className="flex items-center justify-between px-8 py-5 bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex gap-3">
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="w-0.5 flex-1 bg-emerald-100 mt-1" />
                                                </div>
                                                <div className="flex-1 pb-4">
                                                    <p className="text-sm font-medium text-slate-700">Milestone verified</p>
                                                    <p className="text-xs text-slate-500 mt-1">System Test completed</p>
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                <div className="flex-1 pb-4">
                                                    <p className="text-sm font-medium text-slate-700">Task completed</p>
                                                    <p className="text-xs text-slate-500 mt-1">End-to-End Flow Test</p>
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                <div className="flex-1 pb-4">
                                                    <p className="text-sm font-medium text-slate-700">Deliverable uploaded</p>
                                                    <p className="text-xs text-slate-500 mt-1">UAT Test Cases document</p>
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                <div className="flex-1">
                                                    <p className="text-sm font-medium text-slate-700">Project started</p>
                                                    <p className="text-xs text-slate-500 mt-1">Mapping Data phase</p>
